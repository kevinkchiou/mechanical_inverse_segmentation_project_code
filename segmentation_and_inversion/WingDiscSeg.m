...
Seg = struct('WSTil',[]);
for t = 1 : 1
    %Name2 = 'MIPWingDisc57b.tif';
    %Name2 = 'WingDisc57_0-9Proj.tif';
    %Name2 = 'MAX_01ARM57_4ab92013057f1_hrm-1.tif';
    %Name2 = 'archimed_test_raw.tif';
    Name2 = 'tiffs/27_01_29A.tif';
    image = imread(Name2);
    raw=image;image = adapthisteq(image);
